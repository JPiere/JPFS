...
/**
 * 	
 *  JPIERE-0617: Payment Export Class 12
 *  
 ...
 */
public class JapanPaymentExport12 implements PaymentExport
{
	/** Logger								*/
	static private CLogger	s_log = CLogger.getCLogger (JapanPaymentExport12.class);
...
//	private static final int     BP_REFNO = 9;
	...
	public int exportToFile (MPaySelectionCheck[] checks, File file, StringBuffer err)
	{
		...
		try
		{
			...
			line.append("1120")   // dataDiff + code + codeDiff,      1+2+1
