...
/**
 * 	
 *  JPIERE-0616: Payment Export Class 11
 *  
 ...
 */
public class JapanPaymentExport11 implements PaymentExport
{
	/** Logger								*/
	static private CLogger	s_log = CLogger.getCLogger (JapanPaymentExport11.class);
...
//	private static final int     BP_REFNO = 9;
	...
	public int exportToFile (MPaySelectionCheck[] checks, File file, StringBuffer err)
	{
		...
		try
		{
			...
			line.append("1110")   // dataDiff + code + codeDiff,      1+2+1
